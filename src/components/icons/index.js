...
function CircleXMarkIcon({ width = '1.6rem', height = '1.6rem' }) {
    return (
        <svg
            width={width}
            height={height}
...
function MangifyingGlass({ width = '2.4rem', height = '2.4rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
function Messages({ width = '2.6rem', height = '2.6rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
function Profile({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
function Coins({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
function LiveCamera({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
function Gears({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
...
function LanguagesIcon({ width = '2rem', height = '2rem', className }) {
    return (
        <svg
            className={className}
            width={width}
